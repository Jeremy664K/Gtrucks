 ...
 * @author jeremy
 */
public class AcoplarRemolque extends javax.swing.JFrame {

    /**
     * Creates new form AcoplarRemolque
     */
    int id_camion = GestionDeCamiones.id_camionUpdate;
    
    public AcoplarRemolque() {
        initComponents();

        this.setTitle("Acoplar Remolque");
        ...
        try {
            ...
            jScrollPane1.setViewportView(tabla_remolques);

            model.addColumn("ID");
            model.addColumn("Productos");
            model.addColumn("tipo_remolque");
            ...
            tabla_remolques.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if (fila_point > -1) {
                        ...
                        String id_remolque = model.getValueAt(fila_point, 0).toString();
                        String productos = model.getValueAt(fila_point, 1).toString();
                        String tipo_remolque = model.getValueAt(fila_point, 2).toString();

                        String eleccion = JOptionPane.showInputDialog(null, "¿Deseas Acoplar el Remolque " + id_remolque + "? (Si / No)");
                        ...
                        if (eleccion.equalsIgnoreCase("Si") || eleccion.equalsIgnoreCase("S")) {
                            ...
                            try {
                                ...
                                PreparedStatement pst = cn.prepareStatement(
                                 "update camiones set productos = ?, tipo_remolque = ? where ID = '" + id_camion + "'");

                                pst.setString(1, productos);
                                pst.setString(2, tipo_remolque);
                                
                                pst.executeUpdate();
                                
                                cn.close();
                                JOptionPane.showMessageDialog(null, "Remolque Anclado con Exito");
                                
                                dispose();
                                
                            } catch (SQLException x) {
                                System.out.println("Error al anclar remolque al Camion: \n" + x);
                                JOptionPane.showMessageDialog(null, "Error al anclar remolque al Camion, Contacte con el Administrador");
                            }
            ...
            System.err.println("Error, al rellenar la tabla de Acoplar Remolques: \n " + e);
            JOptionPane.showMessageDialog(null, "Error, al rellenar la tabla de Acoplar Remolques, contacte con el Administrador");
        }
    }
    ...
    private void initComponents() {
        ...
        boton_modificar.setText("Registrar Remolque");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AcoplarRemolque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
