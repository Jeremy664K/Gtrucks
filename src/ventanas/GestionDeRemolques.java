 ...
 * @author jeremy
 */
public class GestionDeRemolques extends javax.swing.JFrame {

    /**
     * Creates new form GestionDeCamiones
     */
    String user = Login.user;
    public static int id_remolqueUpdate = 0;

    DefaultTableModel model = new DefaultTableModel();

    public GestionDeRemolques() {
        initComponents();

        this.setTitle("Gestion de Remolques - Sesion de " + user);
        ...
        try {
            ...
            tabla_camiones.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if (fila_point > -1) {
                        ...
                        id_remolqueUpdate = (int) model.getValueAt(fila_point, columna_point);
            ...
            System.err.println("Error, al rellenar la tabla de Remolques: \n " + e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionDeRemolques.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
