 ...
 * @author jeremy
 */
public class GestionDeViajes extends javax.swing.JFrame {

    /**
     * Creates new form GestionDeCamiones
     */
    String user = Login.user;
    public static int id_viajeUpdate = 0;
    ...
    public GestionDeViajes() {
        ...
        this.setTitle("Gestion de Viajes - Sesion de " + user);
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select ID, conductor, viaje, productos, marca from camiones where conductor != 'No Asignado'"
                    + " and viaje != 'No Asignado' and marca != 'No Asignado' and productos != 'No Asignado'");

            ResultSet rs = pst.executeQuery();

            tabla_viajes = new JTable(model);
            ...
            tabla_viajes.addMouseListener(new MouseAdapter() {

                // Evento de mouse para saber que fila selecciono el usuario 
                @Override
                public void mouseClicked(MouseEvent e) {

                    int fila_point = tabla_viajes.rowAtPoint(e.getPoint());
                    int columna_point = 0;

                    if (fila_point > -1) {
                        
                        id_viajeUpdate = (int) model.getValueAt(fila_point, columna_point);
    ...
    private void initComponents() {
        ...
        label_Titulo.setText("Gestion de Viajes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionDeViajes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
